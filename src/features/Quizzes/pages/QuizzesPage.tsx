...
export function QuizzesPage() {
  ...
  useEffect(() => {
    const openQuizId = (location.state as { openQuizId?: number })?.openQuizId
    if (openQuizId && quizzes) {
        ...
        <Dialog open={!!deleteTarget} onOpenChange={() => setDeleteTarget(null)}>
          <DialogContent className="max-w-sm">
            <DialogHeader>
              ...
              <DialogDescription>¿Estás seguro de eliminar "{deleteTarget.titulo}"? Esta acción no se puede deshacer.</DialogDescription>
            </DialogHeader>
