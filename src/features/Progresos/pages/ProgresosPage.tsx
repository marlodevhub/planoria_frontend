...
const stats = [
    { label: 'Días de racha', value: '12', icon: 'ti-flame', color: 'text-orange-400' },
    { label: 'Tarjetas hoy', value: '48', icon: 'ti-cards', color: 'text-accent' },
    { label: 'Quizzes completados', value: '7', icon: 'ti-puzzle', color: 'text-emerald-400' },
    { label: 'Horas estudiadas', value: '3.5', icon: 'ti-clock', color: 'text-yellow-400' },
]
    ...
    return (
        <div className="space-y-6 animate-fade-up">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {stats.map((s) => (
                    <Card key={s.label}>
                        <i className={`ti ${s.icon} ${s.color} text-[24px]`} aria-hidden="true" />
