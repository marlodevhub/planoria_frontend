      ...
      <div className="p-2 space-y-0.5 flex-shrink-0">
        ...
        <button
          ...
          className={cn(
            ...
            "text-muted-foreground hover:text-red-400 hover:bg-red-400/5 transition-all duration-200",
            collapsed && "justify-center",
          )}
        >
        ...
        {isDesktop && (
          <button
            ...
            className={cn(
              "flex items-center gap-3 px-3 py-2.5 rounded-xl w-full",
              "text-muted-foreground hover:text-foreground hover:bg-white/5 transition-all duration-200",
              collapsed && "justify-center",
            )}
          >
