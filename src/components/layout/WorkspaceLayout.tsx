      ...
      <div className="flex flex-col flex-1 min-w-0">
        <header className="flex items-center gap-4 px-6 h-16 flex-shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-2 hover:bg-muted/50 rounded-xl px-3 py-1.5 transition-colors"
          >
            ...
            <div className="text-left hidden sm:block">
              ...
              <p className="text-[11px] text-muted-foreground leading-tight capitalize">{user?.rol ?? 'student'}</p>
            </div>
          </button>
